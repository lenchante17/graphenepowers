...
1. **Create Failing Test Case**
   ...
   - Use the `graphenepowers:test-driven-development` skill for writing proper failing tests
...
- **graphenepowers:executing-plans** - Return to `prepare`, `dispatch`, `unblock`, or `verify` depending on what the investigation reveals

If debugging still cannot identify root cause, open a human gate instead of guessing.
